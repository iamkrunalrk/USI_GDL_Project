...
"""
Unless otherwise stated, all models have r = 3 and are
trained with SGD with momentum 0.9, batch size 32 (16
per worker), an initial learning rate 0.05 (can linearly scale
up with batch size [9]) for 50, 60, and 65 epochs with step
LR decay with a factor of 0.1 at epochs {30, 40}, {30, 50},
and {45, 55} for NTU RGB+D 60, 120, and Kinetics Skeleton 400, respectively. Weight decay is set to 0.0005 for final
models and is adjusted accordingly during component studies. All skeleton sequences are padded to T = 300 frames
by replaying the actions. Inputs are preprocessed with normalization and translation following
"""
